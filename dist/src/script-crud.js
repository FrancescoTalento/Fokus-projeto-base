...
const deletar = (estado) => {
    if (estado.tarefaSelecionada) {
        ...
        return Object.assign(Object.assign({}, estado), { editando: false, tarefaSelecionada: null, tarefas: tarefasNovas });
    }
    return estado;
};
...
const deletarConcluidas = (estado) => {
    return Object.assign(Object.assign({}, estado), { tarefas: estado.tarefas.filter(t => !t.concluida), tarefaSelecionada: null, editando: false });
};
...
const salvarEdicao = (estado, descricaoNova) => {
    const novasTarefas = estado.tarefas.map((tarefa) => {
        if (tarefa == estado.tarefaSelecionada) {
            return Object.assign(Object.assign({}, tarefa), { descricao: descricaoNova });
        }
        return tarefa;
    });
    return Object.assign(Object.assign({}, estado), { tarefas: novasTarefas, tarefaSelecionada: null, editando: false });
};
const atualizarUI = () => {
    const taskIconSvg = `
    ...
    if (estadoInicial.editando && estadoInicial.tarefaSelecionada) {
        formTask === null || formTask === void 0 ? void 0 : formTask.classList.remove('hidden');
    ...
    formTask.onsubmit = (event) => {
        ...
        atualizarUI();
        formTask === null || formTask === void 0 ? void 0 : formTask.reset();
        toggleFormTaskBtn === null || toggleFormTaskBtn === void 0 ? void 0 : toggleFormTaskBtn.click();
    };
    btnCancelar.onclick = () => {
        formTask === null || formTask === void 0 ? void 0 : formTask.reset();
